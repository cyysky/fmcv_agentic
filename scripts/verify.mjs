 ...
 *              + the frontend bundle-size guard + the /agent headroom guard
...
if (process.argv.includes("--build")) {
  ...
  steps.push({ label: "frontend agent-headroom guard", cmd: "node", args: ["scripts/verify-agent-headroom.mjs"], cwd: root });
}
